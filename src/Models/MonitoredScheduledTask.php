...
class MonitoredScheduledTask extends Model
{
    ...
    public static function findForTask(SchedulerEvent|Event $event): ?self
    {
    ...
    public function updateAPI(MonitoredScheduledTaskLogItem $logItem): self
    {
        ...
        dispatch(new SendScheduledJobUpdateToAPI($logItem));
